...
const TransporterHome = () => {
  ...
  const { transporterParcels, loading } = useAppSelector(
    (state) => state.parcel,
  );
      ...
      <ThemedView safe style={styles.container}>
        ...
        >
          <View style={styles.headerContent}>
            <ThemedText style={styles.headerTitle}>Mes livraisons</ThemedText>
            <TouchableOpacity
        ...
        <View style={styles.statsContainer}>
          ...
          <ThemedCard style={styles.statCard}>
            <View
              style={[styles.statIcon, { backgroundColor: "#fbbf24" + "20" }]}
            >
          ...
          <ThemedCard style={styles.statCard}>
            <View
              style={[styles.statIcon, { backgroundColor: "#4ade80" + "20" }]}
            >
                  ...
                  <View style={styles.parcelHeader}>
                    ...
                    <View
                      style={[
                        styles.parcelStatus,
                        {
                          backgroundColor: parcel.delivred
                            ? "#4ade80"
                            : "#fbbf24",
                        },
                      ]}
                  ...
                  <View style={styles.parcelDetails}>
                    ...
                    {parcel.delivred && parcel.isValid !== null && (
                      <View style={styles.qualityStatus}>
                        <Ionicons
                          name={
                            parcel.isValid ? "checkmark-circle" : "alert-circle"
                          }
                          size={16}
